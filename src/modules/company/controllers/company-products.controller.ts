...
export class CompanyProductController {
  ...
  @Post()
  create(@Param('companyId') companyId: string, @Body() data: CreateProductDto) {
  ...
  @Get(':productId')
  findOne(@Param('companyId') companyId: string, @Param('productId') productId: string) {
    return this.productService.findOne(companyId, productId);
  }

  @Patch(':productId')
  update(@Param('companyId') companyId: string, @Param('productId') productId: string, @Body() data: UpdateProductDto) {
    return this.productService.update(companyId, productId, data);
  }

  @Delete(':productId')
  remove(@Param('companyId') companyId: string, @Param('productId') productId: string) {
